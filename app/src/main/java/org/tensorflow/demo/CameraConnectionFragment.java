...
//        }
  ...
  private void createCameraPreviewSession() {
    ...
    tfPreviewListener.initialize(
            getActivity().getAssets(), scoreView, keypointView, inputView, inferenceHandler);
//        getActivity().getAssets(), scoreView, keypointView, inputView, inferenceHandler, sensorOrientation);
